...
public class KafkaStreamsWordCountConsumer {

    private static final Logger logger = LoggerFactory.getLogger(KafkaStreamsWordCountConsumer.class);

    public static void main(String[] args) {
        Properties props = new Properties();

        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, ConsumerConfigValue.BOOTSTRAP_SERVERS);
        props.put(ConsumerConfig.GROUP_ID_CONFIG, ConsumerGroupValue.HYO_STREAMS_WORD_COUNT);
        ...
        try (consumer) {
            consumer.subscribe(List.of(KafkaTopic.STREAMS_WORD_COUNT_OUTPUT));
